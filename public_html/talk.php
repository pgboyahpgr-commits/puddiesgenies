...
<main class="max-w-3xl mx-auto px-4 pb-12">
  ...
  <div class="text-center mb-8 pt-4">
    <h1 class="text-4xl font-bold" style="color:#2D3436;">💬 <span style="color:#4ECDC4;">Talk</span> with Restaurant</h1>
    <?php if ($tableNum > 0): ?>
    <p class="text-gray-500 mt-2">Table #<?= $tableNum ?></p>
    <?php else: ?>
    <p class="text-gray-500 mt-2">Guest</p>
    <?php endif; ?>
    <p id="chatStatus" class="text-xs text-gray-400 mt-1">Initializing...</p>
  </div>
